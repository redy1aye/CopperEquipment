package dev.redy1aye.copperequipment.items;
...
public class CopperBucket extends Item implements FluidModificationItem {
    private final Fluid fluid;

    public CopperBucket(Fluid fluid, Settings settings) {
        super(settings);
        this.fluid = fluid;
    }
    ...
    public static ItemStack getEmptiedStack(ItemStack stack, PlayerEntity player) {
        return !player.getAbilities().creativeMode ? new ItemStack(dev.redy1aye.copperequipment.Items.COPPER_BUCKET) : stack;
    }
